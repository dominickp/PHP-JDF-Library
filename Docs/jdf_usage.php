        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <section>
                    ...
                    <ul>
                        <li>This has to match the substrate name as found on the press/DFE exactly for it to show up on press.</li>
                    </ul>
                ...
                <section>
                    ...
                    <h4>setDevice()</h4>
                    <p>Set the job location. This tells the press/DFE if the job should be held in the DFE queue, print queue, or even to print automatically.</p>
                    ...
                    <ul>
                        <li>Default settings (specifying no parameters) will send the job to be held in the print queue.</li>
                        <li>I think these values might be implementation (HP) specific, so I'll need to determine all of the possible options and then modify this function to throw an exception in case of a bad value.</li>
                    </ul>
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <ul>
                            <li>OneSidedBackFlipX, OneSidedBackFlipY, OneSidedFront, TwoSidedFlipX, TwoSidedFlipY</li>
                        </ul>
                        <li>The external imposition template is an optional parameter and it must be the complete location of the imposition template, where the print device/DFE can locate it.</li>
                    </ul>
                ...
                <section>
                    ...
                    <p>Set gathering parameters. Will research a bit more, but this seems to be HP implementation specific instructions on what to do after the job prints, e.g. insert a slip sheet.</p>
